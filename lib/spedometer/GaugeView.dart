...
class GaugeView extends StatefulWidget {
  ...
  GaugeView(
      {GlobalKey? key,
        ...
        this.unitOfMeasurement = 'Stop In',
        ...
        this.activeGaugeColor = Colors.yellow,
...
class GaugeViewState extends State<GaugeView>
...
class _KdGaugeCustomPainter extends CustomPainter {
  ...
  final double arcStartAngle = 180;
  final double arcSweepAngle = 180;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    center = size.center(Offset(0, 80));
  ...
  void _drawUnitOfMeasurementText(Canvas canvas, Size size) {
    ...
    unitOfMeasurementOffset = unitOfMeasurementOffset.translate(
        -textPainter.width / 2, -textPainter.height / 0.28);
  ...
  void _drawSpeedText(Canvas canvas, Size size) {
    ...
    unitOfMeasurementOffset =
        center!.translate(-textPainter.width / 2, -textPainter.height / 1.2);
    textPainter.paint(canvas, unitOfMeasurementOffset);
  }
